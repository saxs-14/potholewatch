...
Upload size/type handled server-side, CORS restricted, no secrets in source. No admin
auth in this MVP — add it before exposing report-management endpoints publicly.
