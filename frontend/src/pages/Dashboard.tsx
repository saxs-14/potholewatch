...
export default function Dashboard() {
  ...
  useEffect(()=>{if(selected)api.workOrders(selected.id).then(setOrders).catch(()=>setOrders([]));else setOrders([]);},[selected]);
